...
logging.allImg_an_time_id = async (req, res) => {
  ...
  for(let each_hit of allInteractions) {
      ...
      if (participantObjs.includes(each_hit.hit_id)){
        ...
        task_time = (each_hit.log['results'][0].d2/60).toString().slice(0,4);
        instruction_time = (each_hit.log['results'][0].d1/60).toString().slice(0,4);

        csvString += counter + " , "+ each_hit.log['mturk_id'] + "  ,  " +  each_hit.hit_id +  "  ,  " + instruction_time + "  ,  " + task_time + "<br/>"
...
logging.alltxt_an_id = async (req, res) => {
  ...
  for(let each_hit of allInteractions) {
      ...
      if (participantObjs.includes(each_hit.hit_id)){
        ...
        // console.log(each_hit.log['results'])   
        // console.log(each_hit.log['results'][0]) 
        csvString += JSON.stringify(each_hit.log['results']).replace(/<br/g,'') + "<br/>" // .replace(/,/g, ' ')
          // console.log(each_hit.log['results'])
          // console.log(JSON.stringify(each_hit.log['results']))
